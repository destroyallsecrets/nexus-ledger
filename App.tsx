...
function App() {
  ...
  return (
    <div className="min-h-screen bg-nexus-900 text-white flex font-sans overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-nexus-800/20 via-nexus-900 to-nexus-900">
        {/* Header */}
